...
## In a webpage
- For use in a webpage go to [https://github.com/sys-bio/libantimonyjs/releases/latest](https://github.com/sys-bio/libantimonyjs/releases/latest) and copy the contents of `libantimonyjs_#####.zip` into a suitable subdirectory in your website.
...
## Using node.js 
- To use in a node.js project go to [https://github.com/sys-bio/libantimonyjs/releases/latest](https://github.com/sys-bio/libantimonyjs/releases/latest) and copy the contents of `libantimonyjs_#####.zip` into a suitable subdirectory in your project.
